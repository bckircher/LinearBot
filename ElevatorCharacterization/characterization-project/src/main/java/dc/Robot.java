...
public class Robot extends TimedRobot {
  ...
  public void robotInit() {
    ...
    // create left motor
    CANSparkMax leftMotor = setupCANSparkMax(5, Sides.LEFT, false);

    CANSparkMax leftFollowerID6 = setupCANSparkMax(6, Sides.FOLLOWER, false);
    leftFollowerID6.follow(leftMotor, false);
